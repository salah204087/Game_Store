...
namespace Game_StoreAPI.Migrations
{
    ...
    [Migration("20230723132501_ChangeTypeOfEstablichmentDateInGameCompanyTable")]
    partial class ChangeTypeOfEstablichmentDateInGameCompanyTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Game_StoreAPI.Models.GameType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AddedDate = new DateTime(2023, 7, 23, 16, 25, 1, 47, DateTimeKind.Local).AddTicks(2535),
                            Name = "Adventure game",
                            UpdatedDate = new DateTime(2023, 7, 23, 16, 25, 1, 47, DateTimeKind.Local).AddTicks(2580)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            AddedDate = new DateTime(2023, 7, 23, 16, 25, 1, 47, DateTimeKind.Local).AddTicks(2583),
                            Name = "Action",
                            UpdatedDate = new DateTime(2023, 7, 23, 16, 25, 1, 47, DateTimeKind.Local).AddTicks(2584)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            AddedDate = new DateTime(2023, 7, 23, 16, 25, 1, 47, DateTimeKind.Local).AddTicks(2586),
                            Name = "Simulation video game",
                            UpdatedDate = new DateTime(2023, 7, 23, 16, 25, 1, 47, DateTimeKind.Local).AddTicks(2588)
                        },
                        new
                        {
                            Id = 4,
                            ...
                            AddedDate = new DateTime(2023, 7, 23, 16, 25, 1, 47, DateTimeKind.Local).AddTicks(2590),
                            Name = "Sports",
                            UpdatedDate = new DateTime(2023, 7, 23, 16, 25, 1, 47, DateTimeKind.Local).AddTicks(2591)
                        },
                        new
                        {
                            Id = 5,
                            ...
                            AddedDate = new DateTime(2023, 7, 23, 16, 25, 1, 47, DateTimeKind.Local).AddTicks(2593),
                            Name = "Platform game",
                            UpdatedDate = new DateTime(2023, 7, 23, 16, 25, 1, 47, DateTimeKind.Local).AddTicks(2595)
                        });
                });
