...
namespace Game_StoreAPI.Migrations
{
    ...
    [Migration("20230808150317_UpdateShoppingCartItemModel")]
    partial class UpdateShoppingCartItemModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Game_StoreAPI.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Game_StoreAPI.Models.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Game_StoreAPI.Models.ShoppingCartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Game_StoreAPI.Models.Order", b =>
                {
                    b.HasOne("Game_StoreAPI.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Game_StoreAPI.Models.OrderItem", b =>
                {
                    ...
                    b.HasOne("Game_StoreAPI.Models.Order", "Order")
                        .WithMany("OrderItems")
