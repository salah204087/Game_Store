...
namespace Game_StoreAPI.Migrations
{
    ...
    [Migration("20230725150452_AddGamePlatformTableTomakeManyToManyRelation")]
    partial class AddGamePlatformTableTomakeManyToManyRelation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Game_StoreAPI.Models.GameType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AddedDate = new DateTime(2023, 7, 25, 18, 4, 52, 475, DateTimeKind.Local).AddTicks(1006),
                            Name = "Adventure game",
                            UpdatedDate = new DateTime(2023, 7, 25, 18, 4, 52, 475, DateTimeKind.Local).AddTicks(1082)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            AddedDate = new DateTime(2023, 7, 25, 18, 4, 52, 475, DateTimeKind.Local).AddTicks(1092),
                            Name = "Action",
                            UpdatedDate = new DateTime(2023, 7, 25, 18, 4, 52, 475, DateTimeKind.Local).AddTicks(1097)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            AddedDate = new DateTime(2023, 7, 25, 18, 4, 52, 475, DateTimeKind.Local).AddTicks(1103),
                            Name = "Simulation video game",
                            UpdatedDate = new DateTime(2023, 7, 25, 18, 4, 52, 475, DateTimeKind.Local).AddTicks(1108)
                        },
                        new
                        {
                            Id = 4,
                            ...
                            AddedDate = new DateTime(2023, 7, 25, 18, 4, 52, 475, DateTimeKind.Local).AddTicks(1114),
                            Name = "Sports",
                            UpdatedDate = new DateTime(2023, 7, 25, 18, 4, 52, 475, DateTimeKind.Local).AddTicks(1119)
                        },
                        new
                        {
                            Id = 5,
                            ...
                            AddedDate = new DateTime(2023, 7, 25, 18, 4, 52, 475, DateTimeKind.Local).AddTicks(1126),
                            Name = "Platform game",
                            UpdatedDate = new DateTime(2023, 7, 25, 18, 4, 52, 475, DateTimeKind.Local).AddTicks(1131)
                        });
                });
